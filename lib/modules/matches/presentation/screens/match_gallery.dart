...
class MatchGallery extends StatelessWidget {
  const MatchGallery({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<MatchGalleryCubit, BaseState>(
      builder: (context, state) {
        final gallery =
            BlocProvider.of<MatchGalleryCubit>(context).galleryModel;
