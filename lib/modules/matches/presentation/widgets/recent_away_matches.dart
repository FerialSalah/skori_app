...
class RecentAwayMatches extends StatefulWidget {
  const RecentAwayMatches({Key? key}) : super(key: key);

  @override
  State<RecentAwayMatches> createState() => _RecentAwayMatchesState();
}

class _RecentAwayMatchesState extends State<RecentAwayMatches> {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<RecentAwayMatchesBloc, BaseState>(
      builder: (context, state) {
        final recentMatches =
            BlocProvider.of<RecentAwayMatchesBloc>(context).recentAwayMatches;
        print("recent matchhhhhhhhh:${recentMatches.length}");
